...
// ── Claude AI (Anthropic) ────────────────────────────────────────────────────
const SYSTEM_PROMPT = `You are a warm, knowledgeable and friendly assistant for Sandy Majeke Senior Secondary School in Qumbu, Eastern Cape, South Africa.
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      ...
      role: 'bot',
      createdAt: Date.now(),
      text: "👋 Hello! Let me help you! Whether it's admissions, fees, results, activities or anything else about Sandy Majeke SSS — just ask and I'll be happy to assist.",
    },
  ]);
          ...
          <div className="flex items-center justify-between px-4 py-3 bg-school-blue text-white shrink-0">
            <div className="flex items-center gap-2.5 min-w-0">
              ...
              <div className="min-w-0">
                <div className="font-bold text-sm leading-tight truncate">Sandy Majeke SSS Assistant</div>
