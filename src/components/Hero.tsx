...
const slides = [
  { 
    ...
    subtitle: 'Sandy Majeke Senior Secondary School',
    btn: 'Apply Now',
    link: '/admissions'
  },
  { 
    ...
    subtitle: 'CAPS Curriculum Grades 8 – 12',
    btn: 'View Subjects',
    link: '/subjects'
  },
  { 
    ...
    subtitle: 'Committed Educators for Our Learners',
    btn: 'Meet Our Staff',
    link: '/staff'
  },
  { 
    ...
    <div className="relative">
      ...
      <div className="relative h-[400px] w-full overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#A31621]/90 via-[#A31621]/60 to-transparent" />
        </div>
        ...
        <div className="relative h-full max-w-6xl mx-auto px-4 flex items-center">
          ...
          >
            ...
            <a href={slide.link} className="inline-flex items-center gap-2 bg-white text-[#A31621] px-6 py-3 rounded-lg font-bold hover:bg-gray-100 transition">
              {slide.btn}
            </a>
          </motion.div>
        </div>
      ...
      <div className="relative -mt-12 flex justify-center z-10">
        <div className="relative">
          <div className="absolute -inset-3 bg-[#A31621] rounded-xl opacity-25 blur-lg"></div>
          <img 
            src="/assets/logo/sandy-majeke-logo.jpg"
            alt="Sandy Majeke SSS Logo"
            className="relative h-24 w-auto max-w-xs rounded-xl border-4 border-white shadow-xl object-contain bg-white"
          />
        </div>
      </div>
    </div>
