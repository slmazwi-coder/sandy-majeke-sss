      ...
      <div className="py-20 flex items-center justify-center min-h-[60vh]">
        ...
        >
          ...
          <p className="text-gray-600 mb-8">
            Thank you for applying to Sandy Majeke Senior Secondary School. We have received your application and will be in contact shortly.
          </p>
              ...
              >
                ...
                {step === 2 && (
                  <>
                    ...
                    <div className="bg-red-50 border border-amber-200 rounded-xl p-4 text-sm text-amber-800">
