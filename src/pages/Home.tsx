...
const newsItems = [
  {
    ...
    summary: 'Applications for the 2027 academic year are now open. We accept learners from Grades 8 – 10.',
    link: '/admissions'
  },
  {
    title: '96.1% Matric Pass Rate',
    date: '2024',
    summary: 'Our learners achieved a 96.1% matric pass rate. 49 out of 51 learners passed.',
    link: '/achievements'
  },
  {
    title: 'CAPS Curriculum',
    date: 'Ongoing',
    summary: 'Full academic programme including Commerce, Sciences, and Arts streams.',
    link: '/subjects'
  },
];
    ...
    <div className="flex flex-col">
        ...
        <div className="max-w-2xl mx-auto px-4">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              style={{ border: '2px solid #A31621' }}
            >
              <div className="flex items-center justify-center gap-2 text-xs font-semibold mb-3" style={{ color: '#A31621' }}>
                <Calendar size={14} />
              ...
              <a href={newsItems[current].link} className="inline-flex items-center gap-2 font-semibold" style={{ color: '#A31621' }}>
          ...
          <div className="flex justify-center gap-2 mt-4">
            {newsItems.map((_, i) => (
              <button key={i} onClick={() => setCurrent(i)} className={`h-1.5 rounded-full transition-all ${i === current ? 'w-6' : 'w-1.5 bg-gray-300'}`} style={{ backgroundColor: i === current ? '#A31621' : undefined }} />
            ))}
          </div>
        </div>
      </section>
        ...
        <div className="max-w-2xl mx-auto px-4">
          ...
          >
            <video
              ...
              loop
              playsInline
              poster="/assets/logo/sandy-majeke-logo.jpg"
            >
      ...
      <section className="py-10 bg-white">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-3xl md:text-4xl font-light italic" style={{ color: '#A31621' }}>
