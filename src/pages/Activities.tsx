    ...
    <div className="py-12 sm:py-16 bg-white min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-lg text-gray-600 mb-12 max-w-3xl mx-auto">
          Academic activities help learners grow confidence, strengthen problem-solving skills, and prepare for competitions at Sandy Majeke SSS.
        </p>
        ...
        <div className="mt-12 bg-red-50 border border-red-100 rounded-3xl p-6 sm:p-7">
