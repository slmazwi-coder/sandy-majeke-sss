...
const galleryImages: { src: string; caption: string; category: string }[] = [];
    ...
    <div className="py-12 sm:py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-gray-500 max-w-xl mx-auto mb-10 -mt-4">
          A glimpse into life at Sandy Majeke SSS — from the classroom to the sports field, from assembly to the mountain backdrop.
        </p>
        ...
        <div className="flex flex-wrap gap-2 justify-center mb-8">
          {categories.map(cat => (
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-bold transition-all border-2 ${activeCategory === cat ? 'bg-school-blue text-white border-school-blue' : 'bg-white text-school-blue border-school-blue hover:bg-red-50'}`}
            >
              {cat}
            </button>
          ))}
