...
const StepBadge = ({ num, label, active, done }: {
  ...
  <div className="flex items-center gap-2">
    ...
    <span className={`text-xs font-bold uppercase tracking-widest transition-all
      ${active ? 'text-white' : done ? 'text-red-200' : 'text-white/50'}`}>
      {label}
    </span>
  </div>
);
...
const FileUploadRow: React.FC<{
  ...
  return (
    <div className={`flex items-center gap-3 p-3 rounded-xl border-2 transition
      ${file ? 'border-school-blue bg-red-50'
  ...
  if (submitted) {
    return (
      <div className="py-20 flex items-center justify-center min-h-[60vh]">
        ...
        >
          <div className="w-20 h-20 bg-red-100 text-school-blue rounded-full flex items-center justify-center mx-auto mb-6">
            <CheckCircle size={48} />
          </div>
          ...
          <form onSubmit={handleSubmit}>
            <AnimatePresence mode="wait">
              ...
              >
                ...
                {step === 1 && (
                  <>
                    <div className="bg-red-50 border border-amber-200 rounded-xl px-4 py-3 text-xs text-amber-800 font-medium">
                    ...
                    <section>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <Field label="Name & Address of School Admitted To" className="sm:col-span-2">
                          <input className={inp} value={learner.schoolNameAndAddress} onChange={e => patchL('schoolNameAndAddress', e.target.value)} placeholder="Sandy Majeke SSS, Qumbu, 5180" />
                        </Field>
                        ...
                        <table className="w-full text-sm">
                          <thead>
                            <tr>
                              ...
                              <th className="text-left px-3 py-2 bg-red-50 text-xs font-bold text-blue-600 uppercase">Mother / Relative</th>
                            </tr>
                          </thead>
                          <tbody>
                            {([
                  ...
                  <>
                    ...
                    <section className="bg-red-50 border-2 border-red-200 rounded-2xl p-6">
                      <div className="flex gap-4 items-start">
                        <div className="w-12 h-12 bg-red-100 text-blue-600 rounded-xl flex items-center justify-center shrink-0">
                          <Download size={22} />
                        </div>
                    ...
                    <div className="bg-red-50 border border-amber-200 rounded-xl p-4 text-sm text-amber-800 space-y-1.5">
