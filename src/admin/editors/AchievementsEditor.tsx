      ...
      <section className="bg-gray-800 border border-gray-700 rounded-2xl p-6 mb-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-school-blue text-white px-4 py-2 rounded-xl text-sm font-medium hover:bg-red-800"
          >
          ...
          <div className="bg-gray-700 rounded-xl p-4 mb-4 space-y-3">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 pt-2 border-t border-gray-600">
              <button 
                onClick={saveHall} 
                disabled={isScanning}
                className="flex items-center gap-2 bg-school-blue text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-red-800 disabled:opacity-50"
              >
                {isScanning ? (
              ...
              <div className="flex items-center gap-1 text-[9px] text-gray-500 font-bold uppercase tracking-wider">
                <ShieldCheck size={10} className="text-red-500" /> Anti-Malicious Defense Active
              </div>
            </div>
          </div>
        )}
