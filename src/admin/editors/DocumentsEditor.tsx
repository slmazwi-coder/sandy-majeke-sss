  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <button onClick={() => setShowUpload(!showUpload)} className="flex items-center gap-2 bg-school-blue text-white px-4 py-2 rounded-xl font-medium hover:bg-red-800">
        ...
        <div className="bg-gray-800 border border-gray-600 rounded-2xl p-6 mb-8">
          ...
          <div className="flex items-center gap-4">
            <button 
              ...
              className="bg-school-blue text-white px-6 py-2 rounded-xl font-medium hover:bg-red-800 disabled:opacity-50"
            >
              {isScanning ? (
            ...
            <div className="flex items-center gap-1.5 text-[10px] text-gray-500 font-bold uppercase tracking-widest">
              <ShieldCheck size={12} className="text-red-500" /> Active Document Shield
            </div>
          </div>
        </div>
      )}
