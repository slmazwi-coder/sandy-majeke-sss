...
const defaultNews: NewsItem[] = [
  {
    ...
    date: 'Now open',
    content:
      'Applications for the 2027 academic year at Sandy Majeke SSS are now open for Grades 8 – 10. Apply online or contact the school office.',
    image: '',
  },
];
...
const defaultAbout: AboutInfo = {
  ...
  principalMessage: [
    'Welcome to Sandy Majeke Senior Secondary School. We are committed to providing a safe, inclusive and stimulating environment that enables every learner to reach their full potential.',
